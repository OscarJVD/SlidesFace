      ...
      <div className="card newsfeed-user-card h-100">
        <ul className="list-group list-group-flush newsfeed-left-sidebar">
          ...
          <li className="list-group-item d-flex justify-content-between align-items-center sd-active">
            ...
            <a href="#" className="newsfeedListicon"><i className='bx bx-dots-horizontal-rounded' /></a>
          </li>
          ...
          <li className="list-group-item d-flex justify-content-between align-items-center">
            ...
            <span className="badge badge-primary badge-pill"><i className='bx bx-chevron-right' /></span>
          </li>
          <li className="list-group-item d-flex justify-content-between align-items-center">
          ...
          <li className="list-group-item d-flex justify-content-between align-items-center newsLink">
            <a href="https://github.com/ArtMin96/argon-social" target="_blank" className="sidebar-item" rel="noreferrer"><img src="/images/icons/left-sidebar/news.png" alt="find-friends" /> News</a>
            <span className="badge badge-primary badge-pill"><i className='bx bx-chevron-right' /></span>
          </li>
        </ul>
      </div>
    ...
    <div className="col-md-6 second-section" id="page-content-wrapper">
        ...
        <li className="media post-form w-shadow">
          <div className="media-body">
            <div className="form-group post-input">
              <textarea className="form-control" id="postForm" rows="2" placeholder="What's on your mind, Arthur?" />
            </div>
      ...
      <div className="posts-section mb-5">
        <div className="post border-bottom p-3 bg-white w-shadow">
          <div className="media text-muted pt-3">
            ...
            <div className="media-body pb-3 mb-0 small lh-125">
              ...
              <span className="d-block">3 hours ago <i className='bx bx-globe ml-3' /></span>
            </div>
          </div>
          <div className="mt-3">
          ...
          <div className="mb-3">
            ...
            <div className="argon-reaction">
              <span className="like-btn">
                <a href="#" className="post-card-buttons" id="reactions"><i className='bx bxs-like mr-2' /> 67</a>
            ...
            <a href="#" className="post-card-buttons" id="show-comments"><i className='bx bx-message-rounded mr-2' /> 5</a>
                                ...
                                <div className="col-md-12">
                                  <div className="input-group">
                                    ...
                                    <div className="input-group-btn">
                                      <button type="button" className="btn comment-form-btn" data-toggle="tooltip" data-placement="top" title="Tooltip on top"><i className='bx bxs-smiley-happy' /></button>
                                      <button type="button" className="btn comment-form-btn comment-form-btn" data-toggle="tooltip" data-placement="top" title="Tooltip on top"><i className='bx bx-camera' /></button>
                                      <button type="button" className="btn comment-form-btn comment-form-btn" data-toggle="tooltip" data-placement="top" title="Tooltip on top"><i className='bx bx-microphone' /></button>
                                      <button type="button" className="btn comment-form-btn" data-toggle="tooltip" data-placement="top" title="Tooltip on top"><i className='bx bx-file-blank' /></button>
                                    </div>
                                  </div>
                                </div>
                              </div>
                        ...
                        <li className="media">
                          ...
                          <div className="media-body">
                            <div className="d-flex justify-content-between align-items-center w-100">
                              ...
                              <a href="#"><i className='bx bx-dots-horizontal-rounded' /></a>
                            </div>
        ...
        <div className="d-flex justify-content-center my-5 load-post">
          <button type="button" className="btn btn-quick-link join-group-btn border shadow" data-toggle="tooltip" data-placement="top" data-title="Load More Post"><i className='bx bx-dots-horizontal-rounded' /></button>
        </div>
      </div>
    </div>
      ...
      <div className="card shadow-sm">
        <div className="card-body">
          <div className="weather-card-header d-flex justify-content-between align-items-center">
            ...
            <a href="#" className="btn text-primary">California, CA <i className='bx bx-chevron-down' /></a>
          </div>
          <div className="weather-quick align-items-center mt-4">
            <div className="row">
              ...
              <div className="col-md-4">
                <p className="mb-0 fs-1"><i className='bx bx-droplet' /> 15%</p>
                <p className="mb-0 fs-1"><i className='bx bx-flag' /> 10km/h</p>
              </div>
            </div>
          </div>
        </div>
