            ...
            <li className="nav-item">
              <button type="button" className="btn nav-link shadow-none">
                {/* <img
                  ...
                  alt="Quick make post"
                /> */}
                <i className="fas fa-plus text-dark fa-lg " />
              </button>
            </li>
          ...
          <ul className="navbar-nav mr-5 flex-row" id="main_menu">
            ...
            <li className="nav-item s-nav dropdown d-mobile">
              <Tooltip content="Publicar" placement="bottom">
                ...
                >
                  ...
                  <i className="fas fa-plus text-dark fa-sm" />
                </a>
              </Tooltip>
            ...
            <li className="nav-item s-nav dropdown message-drop-li">
              ...
              <Tooltip content="Mensajes" placement="bottom">
                ...
                >
                  ...
                  alt="navbar icon"
                /> */}
                  <i className="fas fa-comments text-dark fa-2x" />
                  ...
                  <li className="px-2 pointer">
                    ...
                    <div className="col-md-10 col-sm-10 col-xs-10">
                      ...
                      <a href="#" className="notify-right-icon">
                        ...
                        <i className="fas fa-circle text-green-lime position-relative fs-5" />
                        <span
                      ...
                      <p className="time">
                        ...
                        {/* 
                              ...
                              */}
                        <i className="fas fa-check text-stroke-white" /> This
            ...
            <li className="nav-item s-nav dropdown notification">
              <Tooltip content="Notificaciones" placement="bottom">
                ...
                /> */}
                  <i className="fas fa-bell fa-2x text-dark" />
                  <span className="badge rounded-circle bg-clear-red">1</span>
                </a>
              </Tooltip>
            ...
            <li className="nav-item s-nav nav-icon dropdown">
              ...
              <a
                ...
                data-placement="bottom"
                data-title="Settings"
                className="nav-link settings-link rm-drop-mobile drop-w-tooltip rounded-circle bg-shadow position-relative d-flex justify-content-center align-items-center"
              ...
              >
                <i
                  ...
                  className="fas fa-sort-down bg-shadow-icon text-dark fa-sm h-100 w-100 d-flex justify-content-center pointer align-items-center"
                 />
                {/* <div className="menu-user-image"> */}
            ...
            >
              ...
              <i className="fas fa-bars text-dark fa-lg fw-bold" />
            </button>
          </ul>
        </div>
      </nav>
