          ...
          <div className="tab-content" id="v-pills-tabContent">
            ...
            <div className="tab-pane fade" id="v-pills-settings" role="tabpanel" aria-labelledby="v-pills-settings-tab">
              ...
              <div className="container my-3">
                ...
                <div className="row">
                  <div className="col-md-2 justify-content-center d-flex align-items-center">
                    <i className="fas fa-phone-alt fa-2x text-gray" />
                  </div>
                ...
                <div className="row mt-4">
                  <div className="col-md-2 justify-content-center d-flex align-items-center">
                    <i className="fas fa-house-user fa-2x text-gray" />
                  </div>
                  <div className="col-md-9">
                    <div className="row">
                      <div className="col-md-12">
                ...
                <div className="row mt-4">
                  <div className="col-md-2 justify-content-center d-flex align-items-center">
                    <i className="fas fa-envelope fa-2x text-gray" />
                  </div>
                  <div className="col-md-9">
                    <div className="row">
                      <div className="col-md-12">
              ...
              <div className="container mt-3">
                ...
                <div className="row">
                  <div className="col-md-2 justify-content-center d-flex align-items-center">
                    <i className={`fas fa-${user.gender == 'male' ? 'male' : 'female'} fa-2x text-gray`} />
                  </div>
                  <div className="col-md-9">
                    <div className="row">
                      <div className="col-md-12">
                ...
                <div className="row mt-4">
                  <div className="col-md-2 justify-content-center d-flex align-items-center">
                    <i className="fas fa-birthday-cake fa-2x text-gray" />
                  </div>
                  <div className="col-md-9">
                    <div className="row">
                      <div className="col-md-12">
