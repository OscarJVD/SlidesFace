        ...
        <div className="w-100 justify-content-md-center">
          ...
          <ul className="nav navbar-nav enable-mobile px-2">
            <li className="nav-item">
              <button type="button" className="btn nav-link p-0">
                <img src="/images/icons/theme/post-image.png" className="f-nav-icon" alt="Quick make post" />
              </button>
            </li>
            ...
            <li className="nav-item">
              <a href="messages.html" className="nav-link nav-icon nav-links message-drop drop-w-tooltip" data-placement="bottom" data-title="Messages">
                <img src="/images/icons/navbar/message.png" className="message-dropdown f-nav-icon" alt="navbar icon" />
              </a>
            </li>
          </ul>
          ...
          <ul className="navbar-nav mr-5 flex-row" id="main_menu">
            <Link className="navbar-brand nav-item mr-lg-5" to="/home">
              <img src="/favicon_logos/be_social_icon.png" width="40" height="40" className="mr-3" alt="Logo" />
            </Link>
            ...
            <li className="nav-item s-nav dropdown message-drop-li">
              ...
              {/* BTN MESSAGES POPUP */}
              <a href="#" onClick={() => setShowMsgs(showMsgs == 'show' ? ' ' : 'show')} className="nav-link nav-links message-drop drop-w-tooltip" data-toggle="dropdown" data-placement="bottom" data-title="Messages" role="button" aria-haspopup="true" aria-expanded="false">
                <img src="/images/icons/navbar/message.png" className="message-dropdown" alt="navbar icon" />
                <span className="badge badge-pill badge-primary">1</span>
              </a>
              {/* END BTN MESSAGES POPUP */}

              {/* MENSAJES POPUP */}
              <ul className={`dropdown-menu notify-drop dropdown-menu-right nav-drop shadow-sm ${showMsgs}`}>
                <div className="notify-drop-title">
                  <div className="row">
                    <div className="col-md-6 col-sm-6 col-xs-6 fs-8">Mensajes | <a href="#">Solicitudes</a></div>
                    <div className="col-md-6 col-sm-6 col-xs-6 text-right">
                      <a href="#" className="notify-right-icon" style={{ fontSize: '0.7rem' }}>
                    ...
                    <div className="col-md-10 col-sm-10 col-xs-10">
                      ...
                      <p className="time">
                        ...
                        {/* 
                              ...
                              */}
                        <i className="fas fa-check text-stroke-white"></i> This party is going to have a DJ, food, and drinks. <span> · </span> <span className="text-muted">2 min</span>
                      </p>
                    </div>
                  </li>
                </div>
            ...
            <li className="nav-item s-nav dropdown notification">
              <a href="#" className="nav-link nav-links rm-drop-mobile drop-w-tooltip" data-toggle="dropdown" data-placement="bottom" data-title="Notifications" role="button" aria-haspopup="true" aria-expanded="false">
                <img src="/images/icons/navbar/notification.png" className="notification-bell" alt="navbar icon" /> <span className="badge badge-pill badge-primary">3</span>
              </a>
            ...
            <li className="nav-item s-nav nav-icon d-mobile d-flex align-items-center justify-content-center text-center">
              <Link to="/profile" data-title="Perfil" className="nav-link settings-link rm-drop-mobile drop-w-tooltip bg-pill-shadow rounded-pill ">
            ...
            <li className="nav-item s-nav nav-icon dropdown">
              ...
              <a href="#" onClick={() => setShowSettings(showSettings == 'show' ? ' ' : 'show')} data-toggle="dropdown" data-placement="bottom" data-title="Settings" className="nav-link settings-link rm-drop-mobile drop-w-tooltip rounded-circle bg-shadow position-relative" style={{ height: '3rem', width: "3rem" }} id="settings-dropdown">
                {/* <div className="menu-user-image"> */}
                {/* <img src={auth.user.avatar}
                    style={{ filter: `${theme ? 'invert(1)' : 'invert(0)'}` }}
                    className="menu-user-img ml-1 nav-settings" alt="Menu Image" /> */}
              ...
              <i onClick={() => setShowSettings(showSettings == 'show' ? ' ' : 'show')} className="fas fa-sort-down bg-shadow-icon text-dark fa-sm position-absolute pointer"></i>
              {/* END BTN DROPDOWN SETTINGS AVATAR */}

              <div className={`dropdown-menu dropdown-menu-right settings-dropdown shadow-sm ${showSettings}`} aria-labelledby="settings-dropdown">
                <Link className="dropdown-item" to="/">
                  <img src="/images/icons/navbar/help.png" alt="Navbar icon" /> Soporte
                </Link>

                <a className="dropdown-item d-table align-items-center dark-mode" href="#" >
                  <img className="" src="/images/icons/navbar/moon.png" alt="Navbar icon" />
                ...
                <Link className="dropdown-item" to="/">
                  <img src="/images/icons/navbar/gear-1.png" alt="Navbar icon" /> Configuración
                </Link>
                <Link className="dropdown-item logout-btn" to="/"
                  onClick={() => dispatch(logout())}>
                  <img src="/images/icons/navbar/logout.png" alt="Navbar icon" /> Salir
                </Link>
              </div>
            </li>
            <button type="button" className="btn border-0 nav-link shadow-none" id="menu-toggle">
