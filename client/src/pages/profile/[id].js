        ...
        <div className="user-profile">
          <div className="profile-header-background">
            <a href="#" className="profile-cover pointer">
              {userData.banner ? (
                <img
                  src={userData.banner ? userData.banner : ""}
            ...
            <div className="col-md-3">
              <div className="profile-info-left">
                <div className="text-center ">
                  ...
                  <p className="profile-fullname mt-3">{userData.fullname}</p>
                  ...
                  {userData.username ? (
                    ...
                    <div className="p-1">
                      <div className={`${showInputUserName ? "d-none" : " "}`}>
                        @
                        <a href="#" onClick={() => setShowInputUserName(true)}>
                          Agrega tu nombre de
                        ...
                        <p className="profile-username mb-3 text-muted d-flex justify-content-center text-center">
                          <div className="input-group d-contents">
                            ...
                            <Tooltip content="Cancelar" placement="bottom">
                              <button
                                type="button"
                                onClick={() => setShowInputUserName(false)}
                  ...
                  <div className="container mt-3">
                    <div className="row justify-content-around d-flex">
                      ...
                      <div className="col-md-4">
                        ...
                        <div>
                          <p className="text-muted fw-semi-bold">Seguidores</p>
                        </div>
                      </div>
                      {/* <div className="col-md-4">
                        <h5>Lorem🈹</h5>
                    ...
                    <div className="container mt-4">
                      <div className="row justify-content-center d-flex text-center">
                        <div className="col-md-6">
                          <p className="fs-7">{userData.story}</p>
                        </div>
                      </div>
                    </div>
                  )}
                ...
                <div className="intro mt-5 mv-hidden">
                  <div className="intro-item d-flex justify-content-between align-items-center">
                    <h3 className="intro-about">Detalles</h3>
                  </div>
                  <div className="intro-item d-flex justify-content-between align-items-center">
                        ...
                        <div className="media-body">
                          <div className="form-group post-input">
                            <textarea
                              ...
                              id="postForm"
                              rows="2"
                              placeholder={`¿Qué estás pensando, ${userData.firstname}?`}
                            ></textarea>
                          </div>
